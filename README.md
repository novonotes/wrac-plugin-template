...
`cargo xtask validate` runs WRAC host-compatibility rules before external format validators.
For the rule list and disable format, see [Validation Rules](docs/validation.md).

...
//! (parameters, state, DSP, GUI); the messy CLAP ABI and FFI invariants are encapsulated in
//! `wrac_clap_adapter`. When building a plugin from this template, you'll mostly be editing the
//! files in this crate.
//!
//! File layout:

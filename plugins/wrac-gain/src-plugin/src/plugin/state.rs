...
use wrac_interface::{PluginError, PluginResult, PluginStateExtension, State};
...
impl PluginStateExtension for WracGainStateExtension {
    fn save_state(&self) -> PluginResult<wrac_interface::PreparedStateSave> {
        ...
        Ok(wrac_interface::PreparedStateSave::new(State { bytes }))
    }
